...
## 🥘 Description
A simple recipe web application built with React. The app provides public browsing and authenticated features, allowing users to create, edit, and manage their own recipes.

## ✨ Features
- <strong>Home Page:</strong> Displays the latest 4 added recipes.
...
- <strong>React frontend:</strong>
    ...
    - npm i 
    - npm run dev
-  <strong>SoftUni Practice Server:</strong>
    - Open in integrated terminal - /client
    - npm run server

## 🌐 Deployment
The project is deployed online and can be accessed here: https://recipes-app-1223f.web.app